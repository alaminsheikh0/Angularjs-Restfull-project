 ...
 */
        ...
        <script src = "ag/js/angular.js"></script>
        <script src = "ag/js/app.js"></script>
        <meta charset = "UTF-8" name = "viewport" content = "width=device-width, initial-scale=1" />
        <link rel = "stylesheet" type = "text/css" href = "ag/css/bootstrap.css"/>
        <link rel = "stylesheet" type = "text/css" href = "ag/css/style.css"/>
