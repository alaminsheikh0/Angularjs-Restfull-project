                ...
                <div class="col-sm-6"> 
                    <form class="form-horizontal" ng-submit="submitSimple()">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control" ng-model="simpleForm.dname"  />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-3" >Manufacture Date</label>
                            <div class="col-sm-9">
                                <input class="form-control" ng-model="simpleForm.ddec"  />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-3" >Quantity</label>
                            <div class="col-sm-9">
                                <input class="form-control" ng-model="simpleForm.dmp" id="n1" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-3" >Price</label>
                            <div class="col-sm-9">
                                <input class="form-control" ng-model="simpleForm.dceo" id="n2" ng-keyup="f1()" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-3" >Total Price</label>
                            <div class="col-sm-9">
                                <input class="form-control" ng-model="simpleForm.dbudget"  />
                            </div>
                        </div>
        ...
        <script>
                    ...
                    app.controller("simpleCtrl", function ($scope, $http) {
                        ...
                        $scope.submitSimple = function () {
                            ...
                            var method = "";
                            var url = "";
                            if ($scope.simpleForm.did == -1) {
                                method = "POST";
                                url = 'service/dpt';
                            } else {

                                method = "PUT";
                                url = 'service/dpt/up/' + $scope.simpleForm.did;
                            }
                        ...
                        $scope.deleteSimple = function (simple) {
                            $http({
                                method: 'DELETE',
                                url: 'service/dpt/del/' + simple.did
                            }).then(_success, _error);
                        };

                        $scope.editSimple = function (simple) {
                            $scope.simpleForm.did = simple.did,
                                    $scope.simpleForm.dname = simple.dname,
                                    $scope.simpleForm.ddec = simple.ddec,
                                    $scope.simpleForm.dmp = simple.dmp,
                                    $scope.simpleForm.dceo = simple.dceo,
                                    $scope.simpleForm.dbudget = simple.dbudget;
                        };

                        function _refreshSimpleData() {
                            $http({
                                method: 'GET',
                                url: 'http://localhost:8080/CompanyManagementSystemWithRESTfullWebService/service/dpt'
                        ...
                        function _clearFormData() {
                            $scope.simpleForm.did = -1,
                                    $scope.simpleForm.dname = "",
                                    $scope.simpleForm.ddec = "",
                                    $scope.simpleForm.dmp = "",
                                    $scope.simpleForm.dceo = "",
                                    $scope.simpleForm.dbuget = 0.0;
                        ...
                        $scope.f1 = function () {
                            ...
                            $scope.simpleForm.dbudget = a1 * a2;
